...
import { Target, Eye, Users, Award, Heart, Zap, Phone, ArrowRight } from 'lucide-react'

export const metadata: Metadata = {
  title: 'About Us — Trusted Physiotherapy Clinic Greater Noida',
  description: 'Learn about SpinalKraft Physiotherapy Clinic — our mission to restore movement, relieve pain, and improve lives in Greater Noida Sector 4.',
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
                  ...
                  <div className="glass-gold rounded-2xl sm:rounded-3xl p-8 sm:p-10 text-center relative overflow-hidden">
                    ...
                    <div className="relative w-20 sm:w-28 mx-auto mb-5">
                      {Array.from({ length: 14 }).map((_, i) => (
                        <div key={i} className="mx-auto mb-[3px] rounded"
                          style={{
                            height: 10,
              ...
              <div className="mt-6 lg:mt-0 space-y-5 sm:space-y-7">
                ...
                {[
                  { icon: Target, title: 'Our Mission', color: '#C9A84C', desc: 'To deliver high-quality physiotherapy care that helps patients recover faster, move better and live pain-free lives through personalized treatment.' },
                  { icon: Eye,    title: 'Our Vision',  color: '#4CAF50', desc: 'To become the most trusted physiotherapy clinic in Greater Noida, recognized for clinical excellence and compassionate care.' },
                  ...
                  <Anim key={title} direction="right" delay={0.1 + i * 0.12}>
                    <div className="glass rounded-xl sm:rounded-2xl p-5 sm:p-6 border border-white/5 hover:border-brand-gold/20 transition-all duration-300">
                      <div className="flex items-start gap-3 sm:gap-4">
                        <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-lg sm:rounded-xl flex-shrink-0 flex items-center justify-center"
              ...
              {VALUES.map(({ icon: Icon, title, desc, color }, i) => (
                <Anim key={title} direction="up" delay={i * 0.1}>
                  <div className="glass rounded-2xl sm:rounded-3xl p-6 sm:p-7 border border-white/5 hover:border-brand-gold/20 transition-all duration-300 group text-center h-full">
                    <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-xl sm:rounded-2xl mx-auto mb-4 flex items-center justify-center group-hover:scale-110 transition-transform duration-300"
                        ...
                        <div>
                          ...
                          <div className="h-2 rounded-full bg-white/5 overflow-hidden">
                            <div className="h-full rounded-full" style={{
                              width: `${pct}%`,
                              background: i % 2 === 0 ? 'linear-gradient(90deg,#C9A84C,#E8C96A)' : 'linear-gradient(90deg,#388E3C,#4CAF50)',
                            }} />
                          </div>
                        </div>
                      </Anim>
